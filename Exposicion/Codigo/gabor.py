...
# 2012-3-8
# Eiichiro Momma
# TOMADO DE: https://web.archive.org/web/20120618161819/http://www.eml.ele.cst.nihon-u.ac.jp/~momma/wiki/wiki.cgi/OpenCV/Gabor%20Filter.html#h2
...
def Process():
    ...
    cv.imshow('Parámetros', dest)
    cv.imshow('Kernel', cv.resize(kernelimg, (kernel_size * 20, kernel_size * 20)))
    cv.imshow('Resultado Final', np.power(dest, 2))
